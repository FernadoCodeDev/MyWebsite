...
const NawBar = () => {
    ...
    return (
        <div className="relative">
            ...
            <div
                className={`fixed text-white top-0 left-0 w-full p-2 md:max-w-40 h-full bg-slate-200 dark:bg-neutral-900  transition-transform duration-700 ease-in-out transform z-50 ${menuOpen ? "translate-x-0" : "-translate-x-full"
                    }`}
            >
