...
export default function ContentPagination({ activePage, pages }) {
  ...
  return (
    <div className="flex flex-col items-start w-full h-auto bg-transparent border border-gray-500 rounded-md">
      ...
      <div className="flex flex-row items-start justify-between w-full gap-2 p-4 bg-transparent border-t border-gray-500">
        {current ? current.content : "Selecciona una sección para ver el contenido"}
      </div>
    </div>
  );
}