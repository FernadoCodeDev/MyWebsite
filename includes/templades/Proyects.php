    ...
    <div class="ProyectColumn ">
        ...
        <div class="Project">
            <div class="ImageContainer">
                <img src="src/Image/LandingMine1.webp" alt="image Project" class="MainImage" />
                <img src="src/Image/LandingMine2.webp" alt="image Project Hover" class="HoverImage" />
            </div>
            <p class="description">
            ...
            Cada landing page en LandingMine está diseñada con una temática única y completamente responsive, adaptándose a distintos dispositivos y tamaños de pantalla. con un total de 18 Landing Pages
         </p>
            ...
            <a href="https://landingmine.netlify.app/" class="buttonContainer">
                <div class="button">
                    <div class="box"></div>
                    <div class="box"></div>
                    <div class="box"></div>
